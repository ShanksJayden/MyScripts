...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "mlrdw3aw26j3xn6fw2sjjq7gy3vpohsalz7zfyi",
    nc: $.getdata("nc_shareCode1") || "823a16fd5683467c9f9df27e0b2c868c",
    mc: $.getdata("mc_shareCode1") || "MTAxODcxOTI2NTAwMDAwMDAxOTc1OTg5Mw==",
    ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5m9cZ2X4iH9PxBPxOcCL6Ik",
    jxgc: $.getdata("jx_shareCode1") || "fwglGp89o4rmlH_vqj_ahQ==",
    jdzz: $.getdata("zz_shareCode1") || "S5KkcRR5M9lGGcknwx6EOcg",
  },
  {
    zd: $.getdata("zd_shareCode2") || "37xayalc6m5aoosl3k5uc5eewfa5smkcsvqzv3a",
    nc: $.getdata("nc_shareCode2") || "751900f706bb47168c69ccc29b7a0a10",
    mc: $.getdata("mc_shareCode2") || "MTAxODc2NTEzNDAwMDAwMDAxOTc2MzM3OQ==",
    ddgc: $.getdata("dd_shareCode2") || "P04z54XCjVWnYaS5jcICWH423lMncf_xcroj34",
    jxgc: $.getdata("jx_shareCode2") || "gulAra62hJWsJnfDX6OKrw==",
    jdzz: $.getdata("zz_shareCode2") || "SvP1yQR4f8FLfPRz3lPAMfQ",
  },
  {
